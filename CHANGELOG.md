...
## [0.3.0](https://github.com/PlexSheep/hedu/compare/v0.2.1...v0.3.0) - 2025-10-18

### Fixed

- *(cli)* accept "-" for stdin marker at any position #2
- [**breaking**] less dependencies and simpler cli #6
- fix ci
- fix name in help
...
- fix regression from #5, don't show time if not in meta logging mode
- *(help)* dirs cannot be dumped #4
- update libpt and adjust to breaking changes #5
